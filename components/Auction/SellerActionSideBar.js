...
import CameraSwitchIcon from '../../assets/ZelpIcons/CameraSwitchIcon.svg';

const SellerActionSideBar = props => {
    const { item, navigation, onChangeCameraView } = props;
        ...
        <View style={styles.mainContainer}>
            <View style={styles.iconContainer}>
                <TouchableOpacity
                    ...
                    <CameraSwitchIcon height={28} width={28} />
                </TouchableOpacity>
...
export default SellerActionSideBar;
