    ...
    return(
        ...
        <View style={styles.container}>
           <View style={styles.imageContainer}>
                <Image  source={require('../../../assets/images/Subscription/orange_background.png')}/>
                <View style={styles.tickImage}><Image source={require('../../../assets/images/Subscription/tick-circle.png')}/></View>
           </View>
           <View>
           ...
           <View style={{marginTop:4}}>
            ...
            <Text style={styles.thirdText}>Froker meal plan subscriber</Text>
           </View>
