    ...
    return (
        <View style={styles.wrapperMealText}>
                <View style={styles.bestMealContainer}>
                    ...
                    <Text style={[styles.changeColor,styles.changeFont]}>Froker</Text> Subscription
                ...
                <View style={styles.bestMealContainer}>
                    ...
                    />
                    <Text style={styles.text}>Our <Text style={[styles.changeColor,styles.changeFont]}>Offerings</Text> for <Text style={styles.changeColor}>you</Text></Text>
