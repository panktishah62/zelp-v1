        ...
        <View style={styles.container}>
            ...
            <View style={styles1.secondContainer}>
                <View style={styles1.leftContainer}>
                    <DeliveryBoy/>
                    <Text style={styles1.firstText}>Distance <Text style={styles1.secondText}>2.4 KM</Text></Text>
                </View>
                <View style={styles1.rightContainer}>
                    <Text style={styles1.thirdText}>Time <Text style={styles1.secondText}>30-35 mins</Text></Text>
                    </View>
