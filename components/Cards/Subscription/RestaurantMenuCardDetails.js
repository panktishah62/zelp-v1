    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles1.secondContainer}>
                    ...
                    <Image source={require('../../../assets/images/Subscription/cycle.png')}/>
                    <Text style={styles1.firstText}>Delivery time <Text style={styles1.secondText}>30-45 Min</Text></Text>
         
            </View>
            <View style={styles2.thirdContainer}>
                <Image source={require('../../../assets/images/Subscription/location.png')}/>
