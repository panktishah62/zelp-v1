...
class FloatingCupcakes extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        const cupcake1Y = this.animatedValue[0].interpolate({
            inputRange: [0, 1],
            outputRange: [height + 50, -50],
        });
        const cupcake2Y = this.animatedValue[1].interpolate({
            inputRange: [0, 1],
        ...
        return (
            <View style={styles.container}>
                <Animated.Image
                    ...
                    style={[
                        styles.cupcake,
                        { transform: [{ translateY: cupcake1Y }] },
                    ]}
                />
                <Animated.Image
                    source={require('../../assets/icons/cupcake.png')}
