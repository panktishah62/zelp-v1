...
class FloatingEllipseLarge extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                />
                <Animated.Image
                    source={require('../../assets/icons/Ellipse3.png')}
                    style={[
                        styles.ellipse,
                ...
                />
                <Animated.Image
                    source={require('../../assets/icons/Ellipse7.png')}
                    style={[
                        styles.ellipse,
...
export default FloatingEllipseLarge;
