...
class FloatingBowls extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        const bowl1Y = this.animatedValue[0].interpolate({
            inputRange: [0, 1],
            outputRange: [height + 50, -50],
        });
        const bowl2Y = this.animatedValue[1].interpolate({
            inputRange: [0, 1],
