export const BASE_URL = 'https://2971-2401-4900-1cb9-abe6-bd57-8953-3612-bc00.ngrok-free.app/api/v1';
...
export const SUBSCRIPTION_RESET_SELECT_MENU_ITEM =
    'SUBSCRIPTION_RESET_SELECT_MENU_ITEM';

export const SUBSCRIPTION_VEG_MENU_ONLY_TRUE =
    'SUBSCRIPTION_VEG_MENU_ONLY_TRUE';
export const SUBSCRIPTION_VEG_MENU_ONLY_FALSE =
    'SUBSCRIPTION_VEG_MENU_ONLY_FALSE';

export const SUBSCRIPTION_MEAL_NUMBER_INCREASED =
    'SUBSCRIPTION_MEAL_NUMBER_INCREASED';
export const SUBSCRIPTION_MEAL_NUMBER_DECREASED =
...
export const SET_SUBSCRIPTION_MEAL_TYPE = 'SET_SUBSCRIPTION_MEAL_TYPE';
...
export const GET_SUBSCRIPTION_CONFIG = 'GET_SUBSCRIPTION_CONFIG';
...
export const APPLY_SUBSCRIPTION_COUPON = 'APPLY_SUBSCRIPTION_COUPON';
export const REMOVE_SUBSCRIPTION_COUPON = 'REMOVE_SUBSCRIPTION_COUPON';

export const ADD_ITEM_TO_SUBSCRIPTION_CART = 'ADD_ITEM_TO_SUBSCRIPTION_CART';
export const REMOVE_ITEM_FROM_SUBSCRIPTION_CART =
    'REMOVE_ITEM_FROM_SUBSCRIPTION_CART';
export const SELECT_ADDRESS_FOR_CART = 'SELECT_ADDRESS_FOR_CART';
export const GET_USER_REFERRAL_COIN_MONEY = 'GET_USER_REFERRAL_COIN_MONEY';
export const APPLY_REFERRAL_CODE_MONEY = 'APPLY_REFERRAL_CODE_MONEY';
export const REMOVE_REFERRAL_CODE_MONEY = 'REMOVE_REFERRAL_CODE_MONEY';
export const UPDATE_MAX_REFERRAL_COIN_MONEY_TO_USE =
